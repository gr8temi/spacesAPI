...
data = [
    {'order_code': '234Spaces-154966', 'name': 'sola', 'email': 'gr8temi@gmail.com'},
    {'order_code': '234Spaces-154966', 'name': 'sola', 'email': 'gr8temi@gmail.com'},
    {'order_code': '234Spaces-154965', 'name': 'sola', 'email': 'gr8temi@gmail.com'},
    {'order_code': '234Spaces-154965', 'name': 'sola', 'email': 'gr8temi@gmail.com'},
]
...
for dat in data:
    if dat["order_code"] in objects:
        objects[dat["order_code"]].extend([dat])
    else:
