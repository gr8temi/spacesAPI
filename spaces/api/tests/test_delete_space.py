...
class DeleteSpaceTest(APITestCase):
    def setUp(self):
    ...
    def test_edit_space(self):
        ...
        edit_url = reverse('delete_space', kwargs={"space_id": space_id})

        response1 = self.client.delete(edit_url, HTTP_AUTHORIZATION=self.header, format='json')
