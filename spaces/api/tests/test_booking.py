...
class TestBooking(APITestCase):
    ...
    def setUp(self):
        ...
        self.hourlyspace = Space.objects.create(**hourly_space_data(), agent=self.agent, space_category=self.space_category_id)
        self.monthlyspace = Space.objects.create(**monthly_space_data(), agent=self.agent, space_category=self.space_category_id)
        self.yearlyspace = Space.objects.create(**yearly_space_data(), agent=self.agent, space_category=self.space_category_id)
    ...
    def test_booking1(self):
        ...
        response6 = self.client.post(self.url2, data6, HTTP_AUTHORIZATION=self.header)
    ...
    def test_reservation(self):
        ...
        **order_extra(),
        ...
        response1 = self.client.post(self.url3, data, HTTP_AUTHORIZATION=self.header)
        self.assertEqual(response1.status_code, 200)
