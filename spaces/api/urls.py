...
urlpatterns = [
    ...
    path(
        "v1/request-reservation-extension/",
        RequestReservationExtension.as_view(),
    ...
    path(
        "v1/single-reservation/<slug:reservation_id>/",
        ReservationDetail.as_view(),
        name="single_reservation",
    ),
    path(
        "v1/reservation/previous-reservation/<slug:user_id>/",
        PreviousReservationPerUser.as_view(),
        name="previous_reservation",
    ),
    path(
        "v1/reservation/upcoming-reservation/<slug:user_id>/",
        UpcomingReservationPerUser.as_view(),
    ...
    path(
        "v1/booking/status/<slug:order_code>/",
        BookingStatus.as_view(),
        name="booking_status",
    ),
    path(
        "v1/booking-cancellation/",
        BookingCancellation.as_view(),
        name="booking_cancellation",
    ),
    path(
        "v1/booking-cancellation/<slug:cancellation_id>/",
        BookingCancellationActions.as_view(),
        name="booking_cancellation_actions",
    ),
    path(
        "v1/booking/update/<slug:order_code>/",
        UpdateReferenceCode.as_view(),
        name="update_reference",
    ),
    path(
        "v1/booking/previous-booking/<slug:user_id>/",
        PreviousBookingPerUser.as_view(),
        name="previous_booking",
    ),
    path(
        "v1/booking/upcoming-booking/<slug:user_id>/",
        UpcomingBookingPerUser.as_view(),
        name="upcoming_booking",
    ),
    path(
        "v1/cancellation/<slug:customer_id>/",
        BookingCancellationPerUser.as_view(),
        name="customer_cancellations",
    ),
    path("v1/favourites/", favourite.AddFavorite.as_view(), name="favourites"),
    path(
        "v1/favourite/delete/<slug:favorite_id>/",
        favourite.DeleteFavourite.as_view(),
        name="delete_favourite",
    ),
    path(
        "v1/favourite/<slug:user_id>/",
        favourite.FetchUserFavourites.as_view(),
        name="favourite",
    ),
    ...
    path(
        "v1/categories/",
        cache_page(CACHE_TTL)(space_category.SpacesCategory.as_view()),
        name="categories",
    ),
    path(
        "v1/space-type/",
        cache_page(CACHE_TTL)(space_type.SpaceTypeView.as_view()),
        name="space_type",
    ),
    path(
        "v1/space-type/<slug:space_type_id>/",
        cache_page(CACHE_TTL)(space_type.SpaceTypeDetail.as_view()),
        name="space_type_detail",
    ),
    path(
        "v1/space-type-category/<slug:category_id>/",
    ...
    path(
        "v1/auth/agents/signup/", agent.AgentRegister.as_view(), name="agent_register"
    ),
    path("v1/agents/", agent.AgentList.as_view(), name="agents"),
    path(
        "v1/auth/agent/<uuid:agent_id>/",
        agent.AgentDetail.as_view(),
        name="agent_details",
    ),
    path(
    ...
    path(
        "v1/auth/customer/<uuid:customer_id>/",
        customer.CustomerDetail.as_view(),
        name="customer_details",
    ),
    path(
        "v1/customer/email/<email>/",
        customer.FetchByEmail.as_view(),
        name="customer_by_email",
    ),
    path(
        "v1/customer/phone_number/<slug:phone_number>/",
        customer.FetchByPhoneNumber.as_view(),
        name="customer_by_phone_number",
    ),
    path(
        "v1/auth/verify-email/", verify_email.VerifyEmail.as_view(), name="verify-email"
    ),
    path(
    ...
    path(
        "v1/change-charge-type/<uuid:agent_id>/",
        UpdateChargeType.as_view(),
        name="change_charge_type",
    ),
    path(
        "v1/subscription/complete/<slug:reference_code>/",
        SubscribeActions.as_view(),
        name="complete_subscriptions",
    ),
    path(
        "v1/subscription/<slug:agent_id>/",
        SubscribeActions.as_view(),
        name="agent_subscription",
    ),
    path(
        "v1/subscription/update-recurring/<slug:reference_code>/",
    ...
    path(
        ...
        CancellationRulesView.as_view(),
        name="cancelation-rule",
    ),
    path(
