        ...
        try:
            ...
            if is_valid_password:
                ...
                if user.is_agent == True:
                    ...
                    return Response(dict(message="Login was successful", token=token, agent=False, customer_id=customer.customer_id, name=user.name, user_id=user.user_id, email=user.email, phone_number=user.phone_number), status=status.HTTP_200_OK)
